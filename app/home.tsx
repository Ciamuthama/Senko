...
export default function App() {
  ...
  const img = image[currentIndex]?.uri || "https://i.postimg.cc/Z5HdWhGT/background-LE-auto-x2.jpg";
  const image2 = {uri: 'https://github.com/Ciamuthama/Portfolio/blob/main/Icon/profile-pic.png'}
  return (
    <BottomSheetModalProvider>
      <View
